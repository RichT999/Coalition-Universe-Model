...
A deterministic model of the universe replacing spacetime variables with invariant coordinates and medium-based wave mechanics.
## Project Architecture
This repository is organized into four primary functional areas:

* **[01 Foundational Postulates](./01_Foundational_Postulates):** Defines the transition from spacetime to Invariant Time Coordination.
